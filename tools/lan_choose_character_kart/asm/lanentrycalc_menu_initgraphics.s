...
###########################################
    ...
    lwz r4, NetGateApp_appHeap(r4)
    li r5, 0x1
    bl JKRArchive_mount
    stw r3, LANEntry_race2DArchive(r31)

    li r3, 0x168
    bl JSystemM_operator_new
    bl J2DPicture_J2DPicture
    stw r3, LANEntry_j2dPicture(r31)

    li r3, 0x1a8
    bl JSystemM_operator_new
    bl J2DPicture_J2DPicture
    stw r3, LANEntry_charBackgroundPictureEx(r31)
    lis r4, J2DPictureEx_vt@h
    ori r4, r4, J2DPictureEx_vt@l
    stw r4, J2DPane_vt(r3)

    li r3, 0x88
    bl JSystemM_operator_new
    bl J2DMaterial_ct
    mr r4, r3
    lwz r3, LANEntry_charBackgroundPictureEx(r31)
    stw r4, J2DPictureEx_j2DMaterial(r3)

    li r3, 2
    li r4, 1
    li r5, -1
    bl J2DMaterial_createTevBlock
    lwz r4, LANEntry_charBackgroundPictureEx(r31)
    lwz r4, J2DPictureEx_j2DMaterial(r4)
    stw r3, 0x70(r4)
    lwz r12, J2DTevBlock_vt(r3)
    lwz r12, j2dTevBlock_initiailize(r12)
    mtctr r12
    bctrl

    lwz r3, LANEntry_charBackgroundPictureEx(r31)
    lwz r3, J2DPictureEx_j2DMaterial(r3)
    lwz r3, J2DMaterial_j2dTevBlock(r3)
...
one_float_loop:
    ...
    lis r4, 0x4280
    stw r4, J2DPane_sizeX(r3)
    stw r4, J2DPane_sizeY(r3)

    li r3, 0x5c
    bl JSystemM_operator_new
    stw r3, LANEntry_j2dPrintForFont(r31)
